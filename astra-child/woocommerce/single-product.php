...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        @media (max-width:768px) { .site-header { padding:12px 20px; } .header-nav { display:none; } .hamburger { display:flex; } .mobile-nav { display:block; } .whatsapp-section { padding:24px 20px; } .site-footer { padding:30px 20px; } }
...
.product-single-wrapper { max-width:1200px; margin:40px auto 80px; padding:0 20px; }
...
if (typeof jQuery !== 'undefined') {
    jQuery(document).on('added_to_cart', function() {
        ...
        if (countBadge.length) { countBadge.text(parseInt(countBadge.text() || 0) + 1); }
    });
}
</script>
<?php wp_footer(); ?>
